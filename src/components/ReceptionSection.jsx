...
export default function ReceptionSection() {
  ...
  const receptionCalUrl = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent('Jithin & Sreelakshmi Wedding Reception')}&dates=20261025T113000Z/20261025T163000Z&details=${encodeURIComponent('Evening Reception from 5:00 PM Onwards at Zahara Convention Centre, Palakkodu.')}&location=${encodeURIComponent('Zahara Convention Centre, Palakkodu')}`;
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          {/* Subtle Corner frames (hidden on mobile) */}
